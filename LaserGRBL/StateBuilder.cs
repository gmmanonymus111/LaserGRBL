...
namespace LaserGRBL
{
	...
	public partial class GrblCommand
	{
		public class StatePositionBuilder : StateBuilder
		{
			...
			{ get { return (!supportPWM || S.Number > 0) && (SpindleState.Number == 106 || SpindleState.Number == 3 || (SpindleState.Number == 4 && MotionMode.Number != 0)); } }
		...
		public class StateBuilder
		{
			...
			*/
			...
			protected ModalElement SpindleState = new ModalElement("M5", "M107", "M3", "M4", "M106");
